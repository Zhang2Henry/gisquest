import { C as CancellationTokenSource, E as Emitter, K as KeyCode, a as KeyMod, P as Position, R as Range, S as Selection, b as SelectionDirection, M as MarkerSeverity, c as MarkerTag, U as Uri, T as Token, e as editor, l as languages, d as lib, _ as __vitePreload } from "./index.c263c66f.js";
...
function parse2(source, filename, withMetadata) {
      ...
      return __generator(this, function(_a) {
        switch (_a.label) {
          case 0:
            ...
            prom = new Promise(function(resolve2, reject) {
              return __awaiter(_this, void 0, void 0, function() {
                ...
                return __generator(this, function(_a2) {
                  switch (_a2.label) {
                    ...
                    case 2:
                      _a2.sent();
                      resolve2(this.grammarForScopeName(initialScopeName));
                      return [2];
                  }
                });
              });
...
tmToMonacoToken.TMToMonacoToken = (editor2, scopes) => {
  let scopeName = "";
  ...
  for (let i = scopes.length - 1; i >= 0; i -= 1) {
    ...
    for (let i2 = scope.length - 1; i2 >= 0; i2 -= 1) {
      ...
      if (char === ".") {
        ...
        if (editor2["_themeService"].getColorTheme()._tokenTheme._match(token + "." + scopeName)._foreground > 1) {
          return token + "." + scopeName;
        }
        if (editor2["_themeService"].getColorTheme()._tokenTheme._match(token)._foreground > 1) {
          return token;
        }
      }
    }
...
function wireTmGrammars(monaco2, registry2, languages2, editor2) {
  return Promise.all(Array.from(languages2.keys()).map(async (languageId) => {
    const grammar2 = await registry2.loadGrammar(languages2.get(languageId));
      ...
      tokenize: (line, state) => {
        ...
        return {
          ...
          tokens: res.tokens.map((token) => ({
            ...token,
            scopes: editor2 ? tm_to_monaco_token_1.TMToMonacoToken(editor2, token.scopes) : token.scopes[token.scopes.length - 1]
          }))
        };
      }
    });
...
var wireTmGrammars_1 = dist.wireTmGrammars = wireTmGrammars;
async function dispatchGrammars(scopeName) {
  switch (scopeName) {
    case "source.vue":
      return {
        format: "json",
        content: await __vitePreload(() => import("./vue.tmLanguage.bad9030c.js"), true ? [] : void 0)
      };
    case "source.ts":
      return {
        format: "json",
        content: await __vitePreload(() => import("./TypeScript.tmLanguage.196b7653.js"), true ? [] : void 0)
      };
    case "source.tsx":
      return {
        format: "json",
        content: await __vitePreload(() => import("./TypeScriptReact.tmLanguage.00d47829.js"), true ? [] : void 0)
      };
    case "source.js":
      return {
        format: "json",
        content: await __vitePreload(() => import("./JavaScript.tmLanguage.729199bb.js"), true ? [] : void 0)
      };
    case "source.js.jsx":
    case "source.jsx":
      return {
        format: "json",
        content: await __vitePreload(() => import("./JavaScriptReact.tmLanguage.d2fef9e6.js"), true ? [] : void 0)
      };
    case "text.html.basic":
      return {
        format: "json",
        content: await __vitePreload(() => import("./html.tmLanguage.651fe5ba.js"), true ? [] : void 0)
      };
    case "source.css":
      return {
        format: "json",
        content: await __vitePreload(() => import("./css.tmLanguage.0df2afc1.js"), true ? [] : void 0)
      };
    case "source.stylus":
      return {
        format: "json",
        content: await __vitePreload(() => import("./stylus.tmLanguage.f7276aad.js"), true ? [] : void 0)
      };
    case "source.markdown":
      return {
        format: "json",
        content: await __vitePreload(() => import("./markdown.tmLanguage.0dbf9e76.js"), true ? [] : void 0)
      };
    default:
      return {
        format: "json",
...
async function loadGrammars(editor2) {
  ...
  await wireTmGrammars_1(monaco, registry2, grammars, editor2);
}
export {
  loadGrammars
};
